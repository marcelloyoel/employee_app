...
<head>
    ...
    <meta content="PT PAS Recruitment" name="description" />
...
<body>
                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="assets/images/pas.png" alt="" width="50%">
                                    {{-- <span class="spinner-border spinner-border-sm mt-15 text-white" role="status"
                                        aria-hidden="true" style="width:1rem; height:1rem;"></span> --}}
                                </a>
                            </div>
                            <p class="mt-3 fs-15 fw-medium">Welcome to the PT. PAS' Employees Portal</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Log In untuk masuk sebagai admin</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form class="user" action="/login" method="post" id="loginForm">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" id="loginBtn" type="submit">Sign
                                                In</button>
                                        </div>
    ...
    {{-- Custom JS --}}
    <script src="assets/js/nonlogin/login.js"></script>
</body>
